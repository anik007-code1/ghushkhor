          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-stone-300 mt-1 leading-relaxed">
                ঘুষখুর প্ল্যাটফর্ম নাগরিক ভোট, সেশন সিকিউরিটি ও প্ল্যাটফর্ম বিশ্লেষণের জন্য কুকি এবং লোকাল স্টোরেজ ব্যবহার করে। ভবিষ্যতে বিজ্ঞাপন চালু হলে গুগল এডসেন্স কুকি প্রয়োগ হতে পারে।
              </p>
            </div>
          </div>
