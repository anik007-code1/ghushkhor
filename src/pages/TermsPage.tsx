...
export default function TermsPage({ onNavigate }: TermsPageProps) {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 md:py-8">
      <SEOHead
        title="ব্যবহারের শর্তাবলি (Terms of Use) | ঘুষখুর"
        description="ঘুষখুর ওয়েবসাইট ব্যবহারের সার্বিক আইনি শর্তাবলি, কপিরাইট, দায়মুক্তি এবং প্রকাশনার শর্তসমূহ।"
        canonicalUrl="/terms"
      />
      ...
      <article className="bg-white p-6 sm:p-10 rounded-2xl border border-stone-200 shadow-sm space-y-8">
        ...
        <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
          ‘ঘুষখুর’ ওয়েবসাইটে প্রবেশ এবং ব্যবহারের মাধ্যমে আপনি এই শর্তাবলি মেনে চলার পূর্ণ সম্মতি জ্ঞাপন করছেন। যদি আপনি এই শর্তাবলির কোনো অংশের সাথে একমত না হন, তবে দয়া করে এই সাইটটি ব্যবহার করা থেকে বিরত থাকুন।
        </p>
        ...
        <section className="space-y-3">
          ...
          <p className="text-stone-700 text-xs sm:text-sm leading-relaxed">
            ব্যবহারকারী যখন কোনো অভিজ্ঞতা বা মন্তব্য জমা দেন, তখন তিনি নিশ্চিত করেন যে তথ্যটি সত্য, তার প্রত্যক্ষ অভিজ্ঞতাপ্রসূত এবং তা কোনো তৃতীয় পক্ষের আইনগত অধিকার বা সম্মানহানি করে না। জমা দেওয়া লেখার বৌদ্ধিক স্বত্ব প্রকাশ ও জনস্বার্থে প্রচারের জন্য ঘুষখুর প্ল্যাটফর্মকে চিরস্থায়ী, রয়্যালটি-মুক্ত লাইসেন্স প্রদান করা হয়।
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-stone-700 text-xs sm:text-sm leading-relaxed">
            ঘুষখুর ওয়েবসাইটে প্রকাশিত মতামত ও অভিজ্ঞতা ব্যবহারকারীদের ব্যক্তিগত অভিব্যক্তি। সাইট কর্তৃপক্ষ কোনো প্রকাশিত লেখার শতভাগ বাস্তব নির্ভুলতার আইনি দায়িত্ব বহন করে না। এই প্ল্যাটফর্মের তথ্যের ওপর ভিত্তি করে গৃহীত কোনো আইনি বা আর্থিক সিদ্ধান্তের দায় সংশ্লিষ্ট ব্যবহারকারীর।
          </p>
        </section>
