...
export default function AboutPage({ onNavigate }: AboutPageProps) {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 md:py-8">
      <SEOHead
        title="ঘুষখোর সম্পর্কে - লক্ষ্য, উদ্দেশ্য ও স্বাধীনতা ঘোষণা | ঘুষখোর"
        description="ঘুষখোর কী, কেন এটি প্রতিষ্ঠিত এবং কীভাবে নাগরিক অভিজ্ঞতার স্বচ্ছ, নিরপেক্ষ ও দায়িত্বশীল প্রকাশ নিশ্চিত করা হয়।"
        canonicalUrl="/about"
      />
      ...
      <Breadcrumbs
        items={[
          { name: 'হোম', url: '/' },
          { name: 'ঘুষখোর সম্পর্কে', url: '/about' },
        ]}
      ...
      <article className="bg-white p-6 sm:p-10 rounded-2xl border border-stone-200 shadow-sm space-y-8">
        ...
        <div className="p-4 sm:p-5 bg-amber-50 border border-amber-200 rounded-xl text-xs sm:text-sm text-amber-900 space-y-2">
          ...
          <p className="leading-relaxed">
            ‘ঘুষখোর’ (GhushKhur) কোনো সরকারি দপ্তর, অধিদপ্তর, মন্ত্রণালয় বা বাংলাদেশ সরকারের অফিশিয়াল কোনো সেবা বাতায়ন নয়। এটি সম্পূর্ণ স্বাধীন, অরাজনৈতিক ও বেসরকারি নাগরিক ফোরাম। কোনো দাপ্তরিক সেবার জন্য অনুগ্রহ করে সংশ্লিষ্ট সরকারি দপ্তরের অফিশিয়াল ওয়েবসাইটে সরাসরি যোগাযোগ করুন।
          </p>
        </div>
        ...
        <section className="space-y-3">
          ...
          <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
            ‘ঘুষখোর’ হলো একটি নাগরিক সেবা পর্যালোচনা ও অভিজ্ঞতা সংরক্ষণের প্ল্যাটফর্ম। একজন সাধারণ নাগরিক যখন ভূমি অফিস, পাসপোর্ট অফিস, বিআরটিএ, বিদ্যুৎ সংযোগ, আদালত কিংবা সরকারি হাসপাতালে সেবা নিতে যান, তখন তিনি যেসব বাস্তব চ্যালেঞ্জ, নিয়মাবলি ও অভিজ্ঞতার মুখোমুখি হন—সেসব তথ্য দায়িত্বশীলভাবে সবার মাঝে তুলে ধরাই এই প্ল্যাটফর্মের কাজ।
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
            সরকারি বিভিন্ন সেবা ডিজিটালাইজড হলেও সাধারণ নাগরিকদের বড় একটি অংশ সঠিক প্রক্রিয়া ও প্রয়োজনীয় কাগজপত্র সম্পর্কে অবগত নন। এর ফলে অনেক ক্ষেত্রে মধ্যস্বত্বভোগী বা দালালদের দৌরাত্ম্য তৈরি হয় এবং নাগরিকরা হয়রানির শিকার হন। ঘুষখোর প্ল্যাটফর্মের মাধ্যমে:
          </p>
