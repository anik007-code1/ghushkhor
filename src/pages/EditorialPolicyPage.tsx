  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 md:py-8">
      <SEOHead
        ...
        description="ঘুষখোর প্ল্যাটফর্মে নাগরিক লেখার পর্যালোচনা পদ্ধতি, ব্যক্তিগত তথ্য অপসারণ, মাননিয়ন্ত্রণ এবং সংশোধনী নীতিমালা।"
      ...
      <article className="bg-white p-6 sm:p-10 rounded-2xl border border-stone-200 shadow-sm space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-stone-700 text-sm leading-relaxed">
            ঘুষখোর কোনো বিচারিক আদালত নয়। আমাদের উদ্দেশ্য কোনো নির্দিষ্ট ব্যক্তিকে প্রকাশ্যে আক্রমণ করা নয়, বরং নাগরিক সেবার প্রক্রিয়াগত ভোগান্তি ও করণীয় তুলে ধরা। তাই সুনির্দিষ্ট কোনো ব্যক্তির নামযুক্ত একতরফা অভিযোগকে অগ্রাধিকার না দিয়ে দপ্তরের সামগ্রিক ব্যবস্থাপনা ও সিস্টেমের ত্রুটিকে ফোকাস করা হয়।
          </p>
        </section>
