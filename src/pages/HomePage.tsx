...
export default function HomePage({ stories = [], settings, onNavigate }: HomePageProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 md:py-8">
      <SEOHead
        title="ঘুষখুর - নাগরিক অভিজ্ঞতা, জনসেবা পর্যবেক্ষণ ও জবাবদিহিতা প্ল্যাটফর্ম"
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-stone-600 max-w-2xl leading-relaxed">
              ঘুষখুর প্ল্যাটফর্মে সকল নাগরিক লেখা বেনামে বা ছদ্মনামে প্রকাশিত হয়। ব্যক্তিগত আক্রোশ, ফোন নম্বর বা জাতীয় পরিচয়পত্র প্রকাশ সম্পূর্ণ নিষিদ্ধ। প্রতিটি লেখা সম্পাদকীয় দল পর্যালোচনা করে প্রকাশ করে।
            </p>
          </div>
